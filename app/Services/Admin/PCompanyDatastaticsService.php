...
class PCompanyDatastaticsService
{
    ...
    public function statisticsZbqk()
    {
        ...
        $data = [
            'fee_kg_zyzj' => bcdiv($fee_kg_zyzj, 10000, 4),
            'fee_kg_wbrz' => bcdiv($fee_kg_wbrz, 10000, 4),
            'fee_kg_zycyzj' => bcdiv($fee_kg_zycyzj, 10000, 4),
            'fee_kg_hjtr' => bcdiv($fee_kg_hjtr, 10000, 4),
            'fee_kg_lnfyzc' => bcdiv($fee_kg_lnfyzc, 10000, 4),
            'fee_kg_xczc' => bcdiv($fee_kg_xczc, 10000, 4),

            'fee_ct_zyzj' => bcdiv($fee_ct_zyzj, 10000, 4),
            'fee_ct_wbrz' => bcdiv($fee_ct_wbrz, 10000, 4),
            'fee_ct_zycyzj' => bcdiv($fee_ct_zycyzj, 10000, 4),
            'fee_ct_hjtr' => bcdiv($fee_ct_hjtr, 10000, 4),
            'fee_ct_lnfyzc' => bcdiv($fee_ct_lnfyzc, 10000, 4),
            'fee_ct_xczc' => bcdiv($fee_ct_xczc, 10000, 4),
        ];
        $this->saveDocxData($data);
    }
    ...
    public function statisticsKjbbqk()
    {
        ...
        $this->saveDocxData([
            'fee_kg_kjyl' => bcdiv($fee_kg_kjyl, 10000, 4),
            'fee_kg_gxsr' => bcdiv($fee_kg_gxsr, 10000, 4),
            'fee_kg_gxzc' => bcdiv($fee_kg_gxzc, 10000, 4),
            'fee_kg_glfy' => bcdiv($fee_kg_glfy, 10000, 4),

            'fee_ct_kjyl' => bcdiv($fee_ct_kjyl, 10000, 4),
            'fee_ct_tzss' => bcdiv($fee_ct_tzss, 10000, 4),
            'fee_ct_cwfy' => bcdiv($fee_ct_cwfy, 10000, 4),
            'fee_kjks' => bcdiv($fee_kjks, 10000, 4),
        ]);
    }
    ...
    public function statisticsSrqk()
    {
        ...
        $this->saveDocxData([
            'fee_srqk_srhj' => bcdiv($fee_srqk_srhj, 10000, 4),
            'fee_srqk_tzss' => bcdiv($fee_srqk_tzss, 10000, 4),
            'fee_srqk_jklx' => bcdiv($fee_srqk_jklx, 10000, 4),
            'fee_srqk_dbf' => bcdiv($fee_srqk_dbf, 10000, 4),
            'fee_srqk_fh' => bcdiv($fee_srqk_fh, 10000, 4),
        ]);
    }
    ...
    public function statisticsBmysqk()
    {
        ...
        $this->saveDocxData([
            'fee_ysqk_gbmyss' => bcdiv($fee_ysqk_gbmyss, 100000000, 4),
            'fee_ysqk_sjfss' => bcdiv($fee_ysqk_sjfss, 100000000, 4),
    ...
    public function statisticsJlcysqk()
    {
        ...
        $this->saveDocxData([
            'fee_ysqk_kgjlcyss' => bcdiv($fee_ysqk_kgjlcyss, 10000, 4),
            'fee_ysqk_ylcsjfss' => bcdiv($fee_ysqk_ylcsjfss, 10000, 4),
    ...
    public function statisticsDwtzqk()
    {
        ...
        $this->saveDocxData([
            'fee_dwtzqk_hjgqtz' => bcdiv($fee_dwtzqk_hjgqtz, 10000, 4),
            'fee_dwtzqk_zqtz' => bcdiv($fee_dwtzqk_zqtz, 10000, 4),
            'fee_dwtzqk_lcsy' => bcdiv($fee_dwtzqk_lcsy, 10000, 4),
            'fee_dwtzqk_hjtr' => bcdiv($fee_dwtzqk_hjtr, 10000, 4),
        ]);
    }
